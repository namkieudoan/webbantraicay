                    ...
                    <ul class="menu biolife-menu clone-main-menu clone-primary-menu" id="primary-menu" data-menuname="main menu">
                        ...
                        <?php 
                            if(isset($_SESSION['user_id'])){
                                 ?>
                                  <li class="menu-item"><a href="exist_order.php">Tracking</a></li>
                                 <?php
                            }
                        ?>
                        ...
                        <div class="mobile-search-content">
                            <form action="#" class="form-search" name="mobile-seacrh" method="get">
                                ...
                                <select name="category">
                                    <option value="-1" selected>Tất cả thư mục</option>
                                    <option value="vegetables">Rau</option>
                                    <option value="fresh_berries">Quả tươi</option>
                                    <option value="ocean_foods">Đồ hải sản</option>
                                    ...
                                    <option value="papaya_crisps">Đu đủ & Crisps</option>

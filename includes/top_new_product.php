<?php 
    $top_new = $obj->display_top_new_pdt();

?>

<div class="advance-product-box">
                                <div class="biolife-title-box bold-style biolife-title-box__bold-style">
                                    <h3 class="title">Top Sản Phẩm Mới Nhất</h3>
                                </div>
                                ...
                                <?php 
                                    while($top_pdt = mysqli_fetch_assoc($top_new)){
                                ...
                                <li class="product-item">
                                        <div class="contain-product right-info-layout contain-product__right-info-layout">
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">$ </span><?php echo $top_pdt['pdt_price']?></span></ins>

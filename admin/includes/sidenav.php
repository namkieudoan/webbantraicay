                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="active">
                                    <a href="dashboard.php">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Trang Chủ Dasboard</span>
                                ...
                                <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)">
                                        <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Các chuyên mục</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="add_cata.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert" style="font-weight: 400;">Thêm chuyên mục</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="manage_cata.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs" style="font-weight: 400;">Quản lý chuyên mục</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="manage_order.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert" style="font-weight: 400;">Quản lý Order</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="add_coupon.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert" style="font-weight: 400;" >Thêm Coupon</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="manage_coupon.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs" style="font-weight: 400;" >Quản lý Coupn</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
